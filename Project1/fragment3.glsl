...
{
  //st = gl_TexCoord[0].xy;
  //float n = snoise(vec3(10.0*gl_TexCoord[0].x, 10.0*gl_TexCoord[0].y, 60.0));
  float n = snoise(vec3(10.0*gl_Position.x, 10.0*gl_Position.y, 60.0));
  gl_FragColor = vec4(0.5*vec3(n, n, n) + 0.5, 1.0);
}
*/
